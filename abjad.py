...
def abjadCalculate(inputStr):
    s = 0
    abjDic = {
                u"ا" : 1, u"إ" : 1, u"أ" : 1, u"آ" : 2, u"ء" : 1, u"ؤ" : 1, u"ئ" : 1, u"ب" : 2,
                u'پ': 2, u'چ': 3,            #for persian support
                u"ج" : 3, u"د" : 4, u"ه" : 5, u"و" : 6, u"ز" : 7,
                u'ژ': 7,             #for persian support
                u"ح" : 8, u"ط" : 9, u"ي" : 10,
                u"ی" : 10, u"ك" : 20, u"ک" : 20, 
                u'گ': 20,            #for persian support
                u"ل" : 30, u"م" : 40, u"ن" : 50, u"س" : 60, 
                u"ع" : 70, u"ف" : 80, u"ص" : 90, u"ق" : 100, u"ر" : 200, u"ش" : 300,
                u"ت" : 400, u"ة": 400,
                u"ث" : 500, u"خ" : 600, u"ذ" : 700, u"ض" : 800, u"ظ" : 900, u"غ" : 1000
    }
...
if __name__ == '__main__':
    allwords = sys.argv[1:] if len(sys.argv) > 1 else sys.stdin.readlines()    
